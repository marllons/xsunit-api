...
class SurvivorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survivor" do
    assert_difference('Survivor.count') do
      post survivors_url, params: { survivor: { age: @survivor.age, name: @survivor.name } }, as: :json
    end
  ...
  test "should update survivor" do
    patch survivor_url(@survivor), params: { survivor: { age: @survivor.age, name: @survivor.name } }, as: :json
    assert_response 200
  end
